...
public class MakeupEngine {
    ...
    /**
     * FUNCTION: doProcessBeautify Do process face region clean and whiten.
     *
     * @param inBitmap, the Bitmap instance which have face region, MUST not
     *            null.
     ...
     */
    public static native boolean doProcessBeautify(Bitmap inBitmap, Bitmap outBitmap,
            int frameWidth, int frameHeight,
            Rect faceRect, int cleanLevel, int beautyLevel);

    /**
     * FUNCTION: doWarpFace Do process face region warp and big eye.
     *
     * @param inBitmap, the Bitmap instance which have face region, MUST not
     *            null.
     * @param outBitmap, the result of process, MUST not null.
     ...
     */
    public static native boolean doWarpFace(Bitmap inBitmap, Bitmap outBitmap, int frameWidth,
            int frameHeight,
