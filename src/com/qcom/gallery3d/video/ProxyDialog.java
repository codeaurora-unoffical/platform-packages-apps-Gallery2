...
//            mSettingKeyProxyPort = MediaStore.Streaming.Setting.HTTP_PROXY_PORT;
        ...
        if (LOG) {
            QcomLog.v(TAG, "ProxyDialog(" + mType + ")");
            QcomLog.v(TAG, "SETTING_KEY_PROXY_HOST=" + mSettingKeyProxyHost);
            QcomLog.v(TAG, "SETTING_KEY_PROXY_PORT=" + mSettingKeyProxyPort);
        }
    }
